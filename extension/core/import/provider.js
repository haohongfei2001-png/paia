...
export class OfficialExportProvider extends HistoryCompletionProvider {
 describe(){return {...officialExportStatus(),contractVersion:1,input:'user_selected_file',network:false};}
 createSession(options){return new ImportCoordinator({...options,adapter:getOfficialExportAdapter()});}
}
