...
export const configDefault=()=>({id:'memory:config',kind:'config',version:1,revision:0,defaultPolicy:'denied',budget:'standard',retentionDays:30,onboarded:false,userTouched:false,externalAccess:true,includeUnorganizedInputs:false});
