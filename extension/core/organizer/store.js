...
export class OrganizerStore extends LibraryDocumentsStore {
 ...
 async searchInputs(o={}){if(o?.universal===true){const {universal,...options}=o;return new UniversalSearchService(this,{aiStatus:()=>this.aiPresentationStatus()}).search(options);}return super.searchInputs(o);}
