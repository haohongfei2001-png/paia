...
export class AIPresentationRunner {
 ...
 await t.put('meta',{...row,state:'committed',phase:'completed',requestCount:calls,committedItemCount:1,candidateCreated,phaseTimestamps:{...row.phaseTimestamps,completed:s.clock()}});});return {completed:true,requestCount:calls,topicId:topic.id,candidateCreated};
