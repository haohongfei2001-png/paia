...
async function runtimeCheck(){try{const r=await fetch('./runtime-check.json',{cache:'no-store'});return await r.json();}catch{return {runtimeParity:false};}}
