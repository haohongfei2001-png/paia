...
test('one shell route preserves source, Project, Conversation and reading position',()=>{
 ...
 const route=appShellRoute({view:'library',documentId:'conversation-2',contextInputId:'input-7',sourcePath:{providerKey:'chatgpt',groupKind:'project',projectRef:'project-1'},searchQuery:'older idea',sort:'desc',anchor},{expanded:['chatgpt-project-1'],scrollTop:300,narrowCollapsed:false});
 assert.deepEqual([route.sourceKey,route.projectRef,route.documentId,route.searchQuery,route.sort,route.anchor],["chatgpt","project-1","conversation-2","older idea","desc",anchor]);
