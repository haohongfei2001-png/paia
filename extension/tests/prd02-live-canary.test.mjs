...
const diagnostics={adapterVersion:'0.3.0',status:'CAPTURING',recentCapture:true,scanned:6,structure,ingestion,captureHealthState:'ACCEPTED',lastErrorCode:null};
