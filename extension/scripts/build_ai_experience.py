"""Package the approved AI Experience checkpoint; never runs or deploys it."""
...
NAME = 'PAIA-v0.7.2c-ai-organizer-mvp'
LABEL = 'v0.7.2c Thought Library AI Experience'
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        raise SystemExit('Usage: python3 scripts/build_ai_experience.py OUTPUT_DIRECTORY')
    package(sys.argv[1])
